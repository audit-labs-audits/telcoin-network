...
use crate::consensus::worker::batch_serde::Token::NewtypeVariant;
use crate::consensus::{Batch, BatchV1, VersionedMetadata, MetadataV1};
...
fn test_serde_batch() {
    ...
    let batch = Batch::V1(BatchV1 {
        ...
        versioned_metadata: VersionedMetadata::V1(
            MetadataV1 { created_at:1666205365890, ..Default::default()}
        ),
    });
