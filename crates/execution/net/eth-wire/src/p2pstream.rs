...
/// [ECIESStream](execution_ecies::stream::ECIESStream) which internally already buffers a few MB of
/// encoded data.
...
/// The [`Encodable`](execution_rlp::Encodable) implementation for [`P2PMessage::Ping`] and
