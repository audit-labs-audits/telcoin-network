...
impl From<execution_interfaces::db::DatabaseError> for BeaconConsensusEngineError {
...
impl From<execution_interfaces::Error> for BeaconForkChoiceUpdateError {
    fn from(e: execution_interfaces::Error) -> Self {
        Self::Internal(Box::new(e))
    }
}
impl From<execution_interfaces::db::DatabaseError> for BeaconForkChoiceUpdateError {
    fn from(e: execution_interfaces::db::DatabaseError) -> Self {
