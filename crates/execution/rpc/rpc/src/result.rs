...
use execution_interfaces::Result as RethResult;
...
impl_to_rpc_result!(execution_interfaces::Error);
impl_to_rpc_result!(execution_network_api::NetworkError);
...
mod tests {
    ...
    fn to_execution_err<Ok>(o: Ok) -> execution_interfaces::Result<Ok> {
        Ok(o)
    }

    #[test]
    fn can_convert_rpc() {
        assert_rpc_result::<(), execution_interfaces::Error, execution_interfaces::Result<()>>();
        let res = to_execution_err(100);
