...
impl TaskDownloader {
    ...
    /// ```
    /// # use std::sync::Arc;
    /// # use execution_downloaders::headers::reverse_headers::ReverseHeadersDownloader;
    /// # use execution_downloaders::headers::task::TaskDownloader;
    /// # use execution_interfaces::consensus::Consensus;
    /// # use execution_interfaces::p2p::headers::client::HeadersClient;
