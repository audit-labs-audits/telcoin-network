...
///
/// - [`HeaderNumbers`][execution_db::tables::HeaderNumbers]
/// - [`Headers`][execution_db::tables::Headers]
/// - [`CanonicalHeaders`][execution_db::tables::CanonicalHeaders]
///
    ...
    D: HeaderDownloader,
{
    ...
    fn is_stage_done<DB: Database>(
        &self,
        tx: &<DB as execution_db::database::DatabaseGAT<'_>>::TXMut,
        checkpoint: u64,
...
mod tests {
    ...
    mod test_runner {
        ...
        use execution_downloaders::headers::reverse_headers::{
