use execution_interfaces::p2p::error::DownloadError;
...
/// ```
/// use execution_downloaders::metrics::BodyDownloaderMetrics;
/// use execution_interfaces::p2p::error::DownloadError;
///
/// // Initialize metrics.
...
/// ```
/// use execution_downloaders::metrics::HeaderDownloaderMetrics;
/// use execution_interfaces::p2p::error::DownloadError;
///
/// // Initialize metrics.
