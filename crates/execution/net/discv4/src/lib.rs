...
use execution_net_nat::ResolveNatInterval;
/// reexport to get public ip.
pub use execution_net_nat::{external_ip, NatResolver};
...
impl Discv4 {
    ...
    ///
    /// If the key already exists, this will update it.
    pub fn set_eip868_rlp(&self, key: Vec<u8>, value: impl execution_rlp::Encodable) {
