...
///
/// - [`BlockOmmers`][execution_db::tables::BlockOmmers]
/// - [`BlockBodies`][execution_db::tables::BlockBodyIndices]
/// - [`Transactions`][execution_db::tables::Transactions]
/// - [`TransactionBlock`][execution_db::tables::TransactionBlock]
///
/// # Genesis
///
...
/// - The [`BlockOmmers`][execution_db::tables::BlockOmmers] table
/// - The [`BlockBodies`][execution_db::tables::BlockBodyIndices] table
/// - The [`Transactions`][execution_db::tables::Transactions] table
#[derive(Debug)]
