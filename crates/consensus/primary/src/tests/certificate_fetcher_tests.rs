...
async fn fetch_certificates_basic() {
    ...
    let (tx_certificate_fetcher, rx_certificate_fetcher) = lattice_test_utils::test_channel!(1000);
    let (tx_new_certificates, _rx_new_certificates) = lattice_test_utils::test_channel!(1000);
    let (tx_parents, _rx_parents) = lattice_test_utils::test_channel!(1000);
