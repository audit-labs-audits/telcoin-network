...
/// Creates a fuzz test for a type that should be [`Encodable`](execution_rlp::Encodable) and
/// [`Decodable`](execution_rlp::Decodable).
///
...
pub mod fuzz_rlp {
    ...
    use execution_primitives::{BlockHashOrNumber, TransactionSigned};
