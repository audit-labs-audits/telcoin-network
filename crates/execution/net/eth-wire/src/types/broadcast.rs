...
pub struct NewPooledTransactionHashes68 {
    ...
    ///
    /// This would make it seem like the [`Encodable`](execution_rlp::Encodable) and
    /// [`Decodable`](execution_rlp::Decodable) implementations should directly use a `Vec<u8>` for
