...
impl TaskDownloader {
    ...
    /// use execution_downloaders::bodies::task::TaskDownloader;
    /// use execution_interfaces::consensus::Consensus;
    /// use execution_interfaces::p2p::bodies::client::BodiesClient;
...
mod tests {
    ...
    use execution_interfaces::{p2p::error::DownloadError, test_utils::TestConsensus};
    use std::sync::Arc;
