...
mod tests {
    ...
    use execution_interfaces::sync::{NetworkSyncUpdater, SyncState};
    use execution_network_api::NetworkInfo;
    use execution_provider::test_utils::NoopProvider;
    use execution_rlp::Decodable;
    use execution_transaction_pool::test_utils::{testing_pool, MockTransaction};
    ...
    async fn test_on_get_pooled_transactions_network() {
        ...
        let _ = transactions
            .pool
            .add_transaction(execution_transaction_pool::TransactionOrigin::External, tx.clone())
            .await;
