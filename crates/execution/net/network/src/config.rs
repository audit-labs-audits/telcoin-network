...
use execution_discv4::{Discv4Config, Discv4ConfigBuilder, DEFAULT_DISCOVERY_PORT};
...
impl NetworkConfigBuilder {
    ...
    ///
    /// ```
    /// # use execution_eth_wire::HelloMessage;
    /// # use execution_network::NetworkConfigBuilder;
