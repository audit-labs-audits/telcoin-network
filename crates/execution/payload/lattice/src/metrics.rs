...
pub(crate) struct PayloadBuilderMetrics {
    ...
    /// Total number of payloads built from consensus output.
    pub(crate) consensus_payload_builds: Counter,
}
...
impl PayloadBuilderMetrics {
    ...
    pub(crate) fn inc_consensus_payload_builds(&self) {
        self.consensus_payload_builds.increment(1);
    }
