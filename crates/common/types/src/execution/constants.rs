...
/// The client version: `lattice/v{major}.{minor}.{patch}`
pub const EXECUTION_CLIENT_VERSION: &str = concat!("lattice/v", env!("CARGO_PKG_VERSION"));
...
/// The Lattice genesis hash.
pub const LATTICE_GENESIS: H256 =
    H256(hex!("8659420394897b996c74255cefd7cba7d2c2279c0acf98509c38de8971e95e06"));
