...
/// ConditionalBroadcastReceiver has an additional method for convenience to conditionally
/// check for shutdown in all branches of a select statement. Using this method
